...
<div id="edit-win" class="easyui-dialog" title="编辑菜单" data-options="closed:true,iconCls:'',modal:true"  style="width:400px;height:280px;">
        ...
        <div class="ui-edit">
            ...
            <div class="fitem">
                ...
                <select class="easyui-combobox" name="conType" value="${conType}" id="conTypes" data-options="required:true">
                    ...
                    <option value="2" <c:if test="${conType == '2'}">selected="selected"</c:if>>商品</option>
                    <option value="5" <c:if test="${conType == '5'}">selected="selected"</c:if>>积分商品</option>
                </select>
            </div>
            <div class="fitem">
                <label>排序:</label>
    ...
    <form id="searchForm" style="display: none;">
        <input name="icId" id="icId" value="${icId}">
    </form>
...
<script type="text/javascript" src="${msUrl}/js/ht/auction/recordList.js"></script>
</body>
</html>
