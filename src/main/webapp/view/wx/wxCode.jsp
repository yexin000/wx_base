...
<html>
  ...
  <body class="easyui-layout">
     ...
     <!-- Edit Win&From -->
     <div id="edit-win" class="easyui-dialog" title="编辑代码" data-options="closed:true,iconCls:'',modal:true"  style="width:500px;height:450px;">  
    	 ...
    	 <div class="easyui-panel" border='false' style="width:450px;height: 350px;">  
	        <div class="easyui-layout" data-options="fit:true">
	            <div data-options="region:'north',split:true" style="height:185px;padding:10px">  
		           ...
		           <div class="fitem">  
		               <label>代码:</label>  
		               <input class="easyui-validatebox" type="text" name="code" data-options="required:true"></input>
		           </div>  
		           <div class="fitem">  
		               <label>代码值:</label>  
  ...
  <script type="text/javascript" src="${msUrl}/js/ht/wx/wxCode.js"></script>
  </body>
</html>
