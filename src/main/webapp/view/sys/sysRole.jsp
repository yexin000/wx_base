  ...
  <head>
   <%@include file="/view/resource.jsp" %>
	...
	<!-- Search panel start -->
     ...
     <!-- Edit Form -->
     <div id="edit-win" class="easyui-dialog" title="编辑角色" data-options="closed:true,iconCls:'',modal:true" style="width:400px;height:410px;">  
...
<script type="text/javascript" src="${msUrl}/js/ht/sys/sysRole.js"></script>
  </body>
</html>
