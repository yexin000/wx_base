			...
			.extend(
					$.LightboxClass.prototype,
					{
						...
						domReady : function() {
							...
							$("body")
									.append(
											'<div id="lightbox-overlay"></div><div id="lightbox"><div id="lightbox-imageBox"><div id="lightbox-imageContainer"><img id="lightbox-image" /><div id="lightbox-nav"><a href="#" id="lightbox-nav-btnPrev"><img style="left: -38%;top: 65%;position: relative;" src="/images/prev.gif"></img></a><a href="#" id="lightbox-nav-btnNext"><img style="right: -38%;top: 65%;position: relative;" src="/images/next.gif"></img></a></div><div id="lightbox-loading"><a href="#" id="lightbox-loading-link"><img src="'
													...
													+ '<span id="lightbox-caption-seperator"></span><span id="lightbox-caption-description"></span></span></div><div id="lightbox-infoFooter"><span id="lightbox-currentNumber"></span><span id="lightbox-close"><a href="#" style="font-size:20px;" id="lightbox-close-button" title="'
													+ this.text.closeInfo
													+ '">'
													+ this.text.close
							...
							$("#lightbox-nav-btnPrev").css("backgroundImage","url(./images/prev.gif) left 45% no-repeat");
