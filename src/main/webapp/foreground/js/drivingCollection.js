...
var headText="";
function getTrafficControlInforByLbbh(lbbh,headInfo){
...
function openList(o) {
    // alert(xh);
    window.location.href = "/weixin/foreground/html/drivingCollection/drivingCollectionItemDetail.html?value=" + encodeURI(o)+"&headText="+encodeURI(headText);
}
 ...
 * @returns {*}
 */
function displayTrafficControlInfor(){
