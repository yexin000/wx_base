...
// ie浏览器版本----------js中连续两个括号立即执行一段代码，并把结果赋给变量；打破我们常规的先写函数，再调用的流程，简化书写。
...
Showbo.Msg = {
	...
	show : function(cfg) {
		...
		if (cfg.wait) {
			...
			this.dvBottom.style.height = '38px';
