$package('WeiXin.wxCode');

WeiXin.wxCode = function(){
	var _box = null;
	var _this = {
		...
		addLine: function(data){
			...
			$(".remove-btn",line).click(function(){
				WeiXin.confirm('Confirm','Are you sure you want to delete record?',function(r){
					if(r){
						_this.delLine(line);
					}
				})
  			...
  			dataGrid:{
  				title:'参数列表',
	   			...
	   			columns:[[
					...
					{field:'code',title:'代码',align:'right',width:80,sortable:true},
					{field:'value',title:'代码值',width:220,sortable:true},
					{field:'remarks',title:'备注',width:220,sortable:true},
					{field:'createTime',title:'创建时间',width:120,sortable:true},
					{field:'updateTime',title:'修改时间',width:120,sortable:true},
					{field:'childMenus',title:'参数',width:120,align:'center',formatter:function(value,row,index){
