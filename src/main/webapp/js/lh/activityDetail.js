...
$(function(){
  ...
  $("#dianzan-btn").click(function () {
    var fabulousBean = {};
    fabulousBean.fabulousId = getParam("id");
    fabulousBean.fabulousType = "3";
    ...
    if(isDianzan) {
      ...
      $.post(url,fabulousBean,function(data){
        ...
        isDianzan = false;
        $("#dianzan-btn").removeClass("header-dianzan-checked").addClass("header-dianzan-uncheck");
      });
    } else {
      ...
      $.post(url,fabulousBean,function(data){
        ...
        isDianzan = true;
        $("#dianzan-btn").removeClass("header-dianzan-uncheck").addClass("header-dianzan-checked");
      });
    }
  });
})
